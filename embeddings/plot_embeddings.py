...
class EmbeddingsPlot:
    ...
    def load_embeddings(
        ...
        self.y = self.dataset_labels[self.label_column].values
...
def main():
    ...
    for concept_name in concepts:
        for model in models:
            ...
            dataset_settings_all = CONCEPT_LABELS[concept_name]

            # loop through all of the concepts
            for dataset_settings in dataset_settings_all:
                _, label_column = dataset_settings
